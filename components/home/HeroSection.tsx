...
const HeroSection = () => {
  ...
  return (
    <section className='h-screen flex flex-col justify-center items-center pt-6 md:pt-16 bg-linear-to-b from-[#f7f9ff] via-[#fffbee] to-[#f7f9ff]'>
      <div className='md:max-w-3xl mx-auto text-center mb-10'>
        <h1 className='text-center text-2xl md:text-6xl md:leading-20 font-semibold md:max-w-4xl text-slate-900'>
          ...
          <span className='relative bg-linear-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text text-nowrap'>
